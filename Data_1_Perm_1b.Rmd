...
output_1b <- pmap(list(b0, big_b1, big_b2, big_b3, big_b4, n_obs, rep), Data_Type_1)
```

```{r}
date()

results_1b <- map_dfr(output_1b, Perm_Method_1b)

full_out_1_1b <- cbind(big_b, results_1b)
