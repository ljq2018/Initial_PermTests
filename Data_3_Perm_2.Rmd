...
#4. Repeat Steps 3-5 many times (m<n!); this is the purpose of the for(j in 1: n_shuffle)
...
output2 <- data.frame(obs_b2, obs_t, ols_pval, perm_pval)
...
output_14 <- pmap(list(b0, big_b1, big_b2, big_b3, big_b4, n_obs, rep), Data_Type_3)
```

```{r}
date()

results_14 <- map_dfr(output_14, Perm_Method_2)

full_out_3_2 <- cbind(big_b, results_14)
