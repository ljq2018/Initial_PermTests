...
```{r}
Data_Type_Control <- function(beta0, beta1, beta2, beta3, beta4, n_obs, rep){
...
output_8 <- pmap(list(b0, big_b1, big_b2, big_b3, big_b4, n_obs, rep), Data_Type_Control)
```

```{r}
date()

results_8 <- map_dfr(output_8, Perm_Method_1a)

full_out_C_1a <- cbind(big_b, results_8)
