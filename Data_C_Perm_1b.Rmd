...
output_9 <- pmap(list(b0, big_b1, big_b2, big_b3, big_b4, n_obs, rep), Data_Type_Control)
```

```{r}
date()

results_9 <- map_dfr(output_9, Perm_Method_1b)

full_out_C_1b <- cbind(big_b, results_9)
