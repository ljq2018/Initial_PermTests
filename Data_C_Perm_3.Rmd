...
output_11 <- pmap(list(b0, big_b1, big_b2, big_b3, big_b4, n_obs,rep), Data_Type_Control)
```

```{r}
date()

results_11 <- map_dfr(output_11, Perm_Method_3)

full_out_C_3 <- cbind(big_b, results_11)
