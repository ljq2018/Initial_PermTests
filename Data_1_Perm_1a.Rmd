...
output_1a <- pmap(list(b0, big_b1, big_b2, big_b3, big_b4, n_obs, rep), Data_Type_1)
```

```{r}
date()

results_1a <- map_dfr(output_1a, Perm_Method_1a)

full_out_1_1a <- cbind(big_b, results_1a)
